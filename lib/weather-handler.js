...
module.exports = class weather {
  constructor() {
    this.currentWeatherObj = new Object();
    //this.getCurrentWeatherData(this.currentWeatherObj);
    console.log(this.getCurrentWeatherData(this.currentWeatherObj));
    console.log(this.currentWeatherObj);
    //console.log(this.currentWeatherData);
    //this.currentWeatherResponse = this.makeCurrentWeatherResponse();
    //console.log(this.currentWeatherResponse);
    //this.forecastWeatherData = this.getForecastWeatherData();
    //console.log(this.currentWeatherData);
  }
  ...
  getCurrentWeatherData(currentWeatherObj) {
    request(CurrentWeatherURL + `?lat=35.66&lon=139.76&` + '&units=metric' + `&appid=${APIKEY}`, (error, response, body) => {
      ...
      currentWeatherObj['weather'] = currentWeather.weather[0].main;
      currentWeatherObj['temp'] = currentWeather.main.temp;
      currentWeatherObj['temp_min'] = currentWeather.main.temp_min;
      currentWeatherObj['temp_max'] = currentWeather.main.temp_max;
      currentWeatherObj['humidity'] = currentWeather.main.humidity;
  ...
  makeCurrentWeatherResponse() {
    let weatherJa = '';
    switch (this.currentWeatherObj.weather) {
      case 'Crear':
